    ...
    $.fn.extend({
        smartpaginator: function (options) {
            ...
            return this.each(function () {
                ...
                var inputPage = $('<input/>').attr('style',' height: 21px').attr('type', 'text').keydown(function (e) {
                ...
                var btnGo = $('<input/>').attr('type', 'button').attr('value', settings.go).attr('style','margin: 0px 0px 0px 0 !important;margin-left:4px').addClass('btn').click(function () { if (inputPage.val() == '') return false; else { currentPage = parseInt(inputPage.val()) - 1; navigate(currentPage); } });
