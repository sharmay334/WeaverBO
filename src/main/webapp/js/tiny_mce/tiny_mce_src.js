	...
	function getHTML5() {
		...
		if (!html5) {
			html5 = mapCache.html5 = unpack({
					...
					'legend[A][C|B]' +
					'div[A||align|widget_name|lang|widget_type|action_name|param_name|u][C]' +
					...
					'mathml[A][]' +
					'svg[A][]' +
					'table[A|border|height|width|color|td|align][caption|colgroup|thead|tfoot|tbody|tr]' +
					'caption[A][C]' +
					'colgroup[A|span][col]' +
					'col[A|span][]' +
					'thead[A][tr]' +
					...
					'tbody[A][tr]' +
					'tr[A][th|td]' +
					'th[A|headers|rowspan|colspan|scope|height|width|align][B]' +
					'td[A|headers|rowspan|colspan|height|width|align][C]' +
					'wbr[A][]'
			);
		}
	...
	function getHTML4() {
		...
		if (!html4) {
			...
			html4 = mapCache.html4 = unpack({
				...
				'h6[E|align][#|S]' + 
				'div[E|align|widget_name|widget_type|action_name|param_name|u][#|Y]' +  //Added By Vaibhav Cause to add new attribute in Div
