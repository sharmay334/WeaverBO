...
<html>
	...
	<script>
		 $(document).ready(function(){
		 	$("#camType").change(function(){
		 		if("REFER_FRIEND"==$("#camType").val()) {
		 			$("#procName").val("campRevReferFrndReport");
		 		} else {
		 			$("#procName").val("CampRevenueReport");
		 		}
		 	});
		 setDefaultDate();
	...
	<body>
		<div class="FormSection">
			...
			<s:form id="campRevenueFrm" action="st_pms_bo_rep_searchReport"
				...
				<div class="innerBox">
					...
					<div class="clearFRM"></div>
						 ...
						 <div class="labelDiv"><s:label value="Campaign Type:" theme="simple"/><em class="Req">*</em></div>
			                <div class="InputDiv">
								<ss:select name="camType" headerKey="-1" 
									headerValue="-- Please Select --" cssClass="select1"
									id="camType" list="#{'REFER_FRIEND':'Refer Friend','PPC':'PPC','AFFILIATE':'Affiliate'}" theme="myTheme" applyscript="true"/>
						</div></div>
