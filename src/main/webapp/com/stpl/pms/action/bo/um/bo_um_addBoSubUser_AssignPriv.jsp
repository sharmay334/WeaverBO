...
<script>
	$(document).ready(
			function() {
			    ...
			    $('input[id="assignBtn"]').click(function(){
					if($('table[id="table_MIS Report"]').find('input[type=checkbox]:checked').val()!=null){
...
<input type="hidden" value='<s:text name="global.um.msg10"></s:text>' id="umerr1"/>
<div class="clear2"></div>
<h2>
	<s:text name="global.subuserregistration.AssignSubUserPrivileges"></s:text>
</h2>
<s:form action="/com/stpl/pms/action/bo/um/bo_um_addBoSubUser_AssignPriv.action" method="POST" onsubmit="return chksub();"
	name="rolePrivForm" theme="simple">
				...
				<div id="tabs-<s:property value="#divService.index+1" />"
					...
					<s:iterator value="%{value}" status="divInterface">
						...
						<h3>
							...
							--></div>
							<div id="accordian_content1" style="display: block;padding-top: 8px;padding-bottom: 8px;margin-top:0px; border:1px #AAAAAA solid;width: 100%;">
...
<div class="box_footer" align="right">
			...
			<input type="submit" id="assignBtn" value='<s:text name="global.subuserregistration.Assign" />' align="center" class="button"
				onclick="" />
		</div>
		</div>
