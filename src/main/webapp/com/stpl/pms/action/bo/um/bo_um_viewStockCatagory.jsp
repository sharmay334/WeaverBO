...
<html>
	<head>
		...
		<title>View Stock Catagory</title>
	...
	<body>
		...
		<div class="FormSection">
			...
			<s:form action="/com/stpl/pms/action/bo/um/bo_um_BoStockCatagory_Search.action" id="searchUserFrm"
				...
				<div class="innerBox">
					...
					<s:if test="%{userInfoBean.getUserType().equalsIgnoreCase('BO')}">
						...
						<div class="FormMainBox">
							...
							<div class="labelDiv">
								<label>
									Select Stock Catagory
								</label>
							</div>
							<div class="InputDiv">
								<s:select name="stockCatagoryName" headerKey="-1"
									headerValue="Select Group Name" list="viewStockCatagoryList"
