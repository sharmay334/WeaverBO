				...
				<table id="payTransactionTable" cellspacing="0"
					...
					<thead>
						<tr>
						    ...
						    <th width="5%" valign="middle" id="th_0" 
								style="text-align: center;">Due Date</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_1">Party Name</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_2">Voucher Number</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_2">Under Emp Name</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_3">Bill Amount</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_2">Over Due Days</th>	
					...
					<tbody>
						<s:iterator value="billBeanMap" var="resultMapVar">
							...
							<tr>
								...
								<s:property value="#attendanceMap.billDate" />
								...
								<td width="5%" valign="middle" style="text-align: center;">
										<b> <s:property value="#attendanceMap.empName" /> </b> 
								</td>
								<td width="5%" valign="middle" style="text-align: center;">
										<b> <s:property value="#attendanceMap.billAmount" /> </b> 
								</td>
								<td width="5%" valign="middle" style="text-align: center;">
									<s:property value="#attendanceMap.dueDays" />
								</td>
							</tr>
						</s:iterator>
					</tbody>
