...
function getTeamTarget(tsmName){
	
var myurl = "<%=basePath%>";
	
	var frm = $('#searchUserFrm');
	myurl += "/com/stpl/pms/action/bo/um/getTSMTeamTargetAmount.action?tsmName="+tsmName+"&subTeamName="+document.getElementById('subTeamName').value;
...
<body>
	<div class="FormSection">
		...
		<s:form id="searchUserFrm"
			action="/com/stpl/pms/action/bo/um/bo_um_assignSMSubTeam_submit.action"
			...
			<div class="innerBox">
				...
				<div class="FormMainBox">
					<div class="labelDiv">
						<label>Select Under TSM</label><em class="Req">*</em>
					</div>
					<div class="InputDiv">
						<s:select name="tsmName" headerKey="-1" id="tsmName"
								headerValue="--Please Select--" list="empNameList"
								cssClass="select1" theme="myTheme" onChange="getTeamTarget(this.value)" errorMassage="Select TSM First"/>
				...
				<div class="FormMainBox">
					<div class="labelDiv">
						<label>Select SM</label><em class="Req">*</em>
					</div>
					<div class="InputDiv">
						<s:select name="smName" headerKey="-1" id="smName"
								headerValue="--Please Select--" list="empNameList"
								cssClass="select1" theme="myTheme" errorMassage="Select SM First"/>
				...
				<div class="FormMainBox">
					<div class="labelDiv">
						<label>SM Target Amount</label><em class="Req">*</em>
					</div>
					<div class="InputDiv">
						<ss:textfield maxlength="30" id="smTarget" applyscript="true"
							theme="myTheme" name="smTarget" pattern="^[0-9.]*$"
							errorMassage="Only Numeric Character not allowed"
							theme="myTheme"></ss:textfield>
						<div id="smTarget_error" class="fieldError">
							<s:fielderror>
								<s:param>smTarget</s:param>
							</s:fielderror>
						</div>
					</div>
				</div>
