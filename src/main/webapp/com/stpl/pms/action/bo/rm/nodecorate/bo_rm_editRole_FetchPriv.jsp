...
<script>
	$(document).ready(
			...
			active : false
			    ...
			    $('input[id="submit_DomainPrivileges"]').click(function(){
					if($('table[id="table_MIS Report"]').find('input[type=checkbox]:checked').val()!=null){
	...
	var flag = true;
	if($('#roleId').val() == -1){
	document.getElementById("roleName_error").className="fieldError";	    	
	document.getElementById("roleName_error").innerHTML = "Please Enter a role Name";
	...
	$('.chkOne').each(function() {
				...
				if(c == false){
				alert("Please Check Atleast One Role Priviledge");
				flag = false;
				}
...
<div class="box_footer" align="right">
			<s:submit id="submit_DomainPrivileges" value="Edit Role" align="center" cssClass="button"
