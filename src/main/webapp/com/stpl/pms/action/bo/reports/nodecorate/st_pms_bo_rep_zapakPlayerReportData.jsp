...
<body>
	...
	<div class="FormSection">
		<s:if test="%{resultList!=null && resultList.size()>0}">
			<div class="greyStrip">
				<h4 style="float: left">
					Zapak Player Report For Domain :
				...
				<table cellspacing="0" cellpadding="4" border="0" align="center"
					...
					<thead>
						<tr class="headerRow">
							...
							<th valign="middle" style="text-align: center;">Last Name</th>
							<th valign="middle" style="text-align: center;">Email Id</th>
							<th valign="middle" style="text-align: center;">Mobile
								Number</th>
							<th valign="middle" style="text-align: center;">Date Of
								Registration</th>
							<th valign="middle" style="text-align: center;">Total
								Deposit</th>
							<th valign="middle" style="text-align: center;">Total Wager</th>
							<th valign="middle" style="text-align: center;">Total
								Winning</th>
							<th valign="middle" style="text-align: center;">Total
								Withdrawal</th>
