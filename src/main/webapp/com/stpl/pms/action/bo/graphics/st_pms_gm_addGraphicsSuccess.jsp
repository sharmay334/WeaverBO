...
<html>
  <head>
    ...
    <title>My JSP 'st_pms_gm_addMenuSuccess.jsp' starting page</title>
    ...
    <div class="FormSection">
			...
			<div class="innerBox">
					...
					<div class="innerBox">
						...
						Graphics Uploaded SuccessFully.Please Find Below Details.</div>
					    </div>  
					<table id="payTransaction" class="payTransaction" align="center"
						...
						<tbody>
							...
							<s:iterator value="graphicsUrlDetail" status="graphicsUrlDetail">
								<tr>
