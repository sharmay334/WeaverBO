...
function callPictureReportVisit(visitId){
	...
	$(document).ready(function() {
		...
		var append="Employee Name - "+document.getElementById('empName').value+"\n";
		if(document.getElementById('fromDate').value.length>2){
			
			append = append + "Date - From : ( "+document.getElementById('fromDate').value+" ) - To : ( "+document.getElementById('toDate').value+" )\n"
		}
			...
			<table id="payTransactionTable" cellspacing="0"
					...
					<thead>
						<tr>
						    ...
						    <th width="5%" valign="middle" id="th_1" 
								style="text-align: center;">Distributor Name</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_3">Retailer Name</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_4">Prop Name</th>
								<th width="5%" valign="middle" style="text-align: center;"
								id="th_4">contact</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_2">Number of Visit</th>
					...
					<tbody>
						<s:iterator value="visitMapResult" var="resultMapVar">
							...
							<tr>
								<td width="5%" valign="middle" style="text-align: center;"><a href="javascript:;" onclick="getDetailedInfo('<s:property value="#resultMapVar.key" />','<s:property value="#attendanceMap.visitUniqueId" />')"><s:property value="#resultMapVar.key" /></a></td>
								<td width="5%" valign="middle" style="text-align: center;">	<s:property value="#attendanceMap.retailerName" /></td>
								...
								<td width="5%" valign="middle" style="text-align: center;"><s:property value="#attendanceMap.noOfVisit" /></td>
							</tr>
						</s:iterator>
					</tbody>
				</table>
