...
<body>
	...
	<div class="FormSection">
		<s:if
			test="%{billBeanMap!=null && billBeanMap.size()>0}">
			<div class="greyStrip">
				<h4 style="float: left">Supercash Bill Report</h4>
			...
			<s:form id="searchUserFrm2" method="GET" action="/com/stpl/pms/action/bo/um/bo_um_viewEmpWiseVisitDetails_submit.action"
			 target="expandIt" theme="simple">
				<table id="payTransactionTable" cellspacing="0"
					...
					<thead>
						<tr>
							...
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_3">Voucher No</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_4">Bill Amount</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_2">Bill Paid</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_2">Bill Due</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_4">Bill Date</th>	
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_2">Bill Due Date</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_2">Due Days</th>
					...
					<tbody>
						<s:iterator value="billBeanMap" var="resultMapVar">
							<s:set var="attendanceMap" value="#resultMapVar.value" />
							<tr>
								<td width="5%" valign="middle" style="text-align: center;">	<s:property value="#attendanceMap.ledgerName" /></td>
								<td width="5%" valign="middle" style="text-align: center;"><s:property value="#attendanceMap.billVoucherNo" /></td>
								<td width="5%" valign="middle" style="text-align: center;"><s:property value="#attendanceMap.actualBillAmount" /></td>
								<td width="5%" valign="middle" style="text-align: center;"><s:property value="#attendanceMap.billUsed" /></td>
								<td width="5%" valign="middle" style="text-align: center;"><s:property value="#attendanceMap.billAmount" /></td>
								<td width="5%" valign="middle" style="text-align: center;"><s:property value="#attendanceMap.billDate" /></td>
								<td width="5%" valign="middle" style="text-align: center;"><s:property value="#attendanceMap.billDueDate" /></td>
								<td width="5%" valign="middle" style="text-align: center;"><s:property value="#attendanceMap.dueDays" /></td>
							</tr>
						</s:iterator>
					</tbody>
				</table>
