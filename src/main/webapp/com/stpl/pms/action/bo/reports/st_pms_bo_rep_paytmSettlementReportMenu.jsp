...
<html>
	...
	<body>
		<div class="FormSection">
			...
			<s:form id="plrDepoSearchFrm" action="st_pms_bo_rep_paytmSettReportSearch" target="searchResult" theme="simple" method ="post">
				<div class="innerBox">
					...
					<div class="FormMainBox">
						...
						<div class="InputDiv">
							<s:select theme="myTheme" cssClass="select1" applyscript="true"
								list="{'PAYTM'}" name="providerName" id="providerName" 
					...
					<div class="FormMainBox">
						...
						<div class="InputDiv">							
								<select class="select1" name="paytmSettlstatus"  id="paytmSettlstatus"  applyscript="true">
