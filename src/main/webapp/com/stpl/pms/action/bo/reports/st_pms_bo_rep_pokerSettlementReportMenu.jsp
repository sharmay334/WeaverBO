...
<html>
	...
	<body>
		<div class="FormSection">
			<div class="greyStrip">
				<h4>Poker Settlement Report </h4>
			</div>
			<s:form id="plrDepoSearchFrm" action="st_pms_bo_rep_pokerSettReportSearch" target="searchResult" theme="simple" method ="post">
				<div class="innerBox">
					...
					<div class="FormMainBox">
						...
						<div class="InputDiv">
							<s:select theme="myTheme" cssClass="select1" applyscript="true"
								list="{'POKER'}" name="providerName" id="providerName" 
					...
					<div class="FormMainBox">
						...
						<div class="InputDiv">							
								<select class="select1" name="pokerSettlstatus"  id="pokerSettlstatus"  applyscript="true">
