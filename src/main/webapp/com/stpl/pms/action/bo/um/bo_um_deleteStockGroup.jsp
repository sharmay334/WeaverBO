...
<html>
	...
	<body>
		...
		<div class="FormSection">
			...
			<s:form action="/com/stpl/pms/action/bo/um/bo_um_BoStock_delete.action" id="searchUserFrm"
				...
				<div class="innerBox">
					...
					<s:if test="%{userInfoBean.getUserType().equalsIgnoreCase('BO')}">
						...
						<div class="FormMainBox">
							...
							<div class="InputDiv">
								<s:select name="stockName" headerKey="-1"
									headerValue="Select Stock Name" list="viewStockGroupList"
