...
var CurrentBalance = 0;
	...
	function callForMoreRow(id) {
		...
		if (document.getElementById('particularsList' + rowCount).value != "-1") {
			...
			var g = oInput.childNodes[5].childNodes[1];
			var h = oInput.childNodes[7].childNodes[1];
...
<body>
	...
	<div class="FormSection">
		...
		<s:form
			action="/com/stpl/pms/action/bo/um/bo_um_BoEmpcontra_create.action"
							...
							<tr id="rowId1">
								...
								<td style="text-align: center;" nowrap="nowrap">
									<s:select
										...
										cssClass="select1" theme="myTheme" cssStyle="width:50px;" />
									</td>
							</tr>
