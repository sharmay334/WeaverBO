...
<html>
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function() {
					...
					if(vendorAvailable) */
						$('#providerName').append($('<option></option>').val("PAYTM").html("PAYTM"));
	...
	<body>
		<div class="FormSection">
			<div class="greyStrip">
				<h4>
					Upload Payment Paytm Settlement Data
				</h4>
			</div>

			<s:form id="uploadData"
				action="st_pms_bo_csh_uploadPaytmSettlement_Save" theme="simple" enctype="multipart/form-data" method="post">
				...
				<div class="FormMainBox">
					...
					<div class="FormMainBox">
						...
						<div class="InputDiv">
							<s:file name="paytmSettlement" id="paytmSettlement" applyscript="true" accept=".csv" theme="myTheme"></s:file>
						</div>
