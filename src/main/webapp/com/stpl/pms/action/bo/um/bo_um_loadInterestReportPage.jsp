...
<body>
	<div class="FormSection">
		...
		<s:form id="searchUserFrm" action="/com/stpl/pms/action/bo/um/bo_um_interestReportResult.action"
			...
			<div class="innerBox">
				<div class="FormMainBox">
					...
					<div class="InputDiv">
						<div>
							<ss:select theme="myTheme" cssClass="select1" list="%{ledgerNames}"
								name="ledgerName" id="ledgerName" headerKey="-1" headerValue="--Please Select--">
							</ss:select>
						</div>
					</div>
				</div>
