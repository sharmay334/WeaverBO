...
<body>
	...
	<div class="FormSection">
		<s:if
			...
			<div class="greyStrip">
				<h4 style="float: left">Product Stock Report</h4>
				...
				<table id="payTransactionTable" cellspacing="0"
					...
					<thead>
						<tr>
							<th width="5%" valign="middle" id="th_0" 
								style="text-align: center;">Item Name</th>
						    <th width="5%" valign="middle" id="th_0" 
								style="text-align: center;">Item Bulk Unit</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_1">Item Alt Unit</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_2">Item Unit</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_2">Item Net Qty</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_2">Item Net Price</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_2">Item Net Value</th>	
					...
					<tbody>
						<s:iterator value="reportData" var="resultMapVar">
							...
							<tr>
								<td width="5%" valign="middle" style="text-align: center;"><s:property value="#attendanceMap.itemName" /></td>
								<td width="5%" valign="middle" style="text-align: center;">	<s:property value="#attendanceMap.itemUnitBulk" /></td>
								<td width="5%" valign="middle" style="text-align: center;"><s:property value="#attendanceMap.itemUnitAlt" /></td>
