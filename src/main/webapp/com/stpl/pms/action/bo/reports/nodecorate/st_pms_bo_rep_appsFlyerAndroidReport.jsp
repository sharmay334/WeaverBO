...
<body>
	...
	<div class="FormSection">
		<s:if test="%{resultList!=null && resultList.size()>0}">
			<div class="greyStrip">
				<h4 style="float: left">AppsFlyer Android Data Report</h4>
			</div>
				...
				<table cellspacing="0" cellpadding="4" border="0" align="center"
					...
					<thead>
						<tr class="headerRow">
								...
								<th valign="middle" style="text-align: center;">Advertising Id</th>
								<th valign="middle" style="text-align: center;">Android Id</th>
								<th valign="middle" style="text-align: center;">IMEI</th>
								<th valign="middle" style="text-align: center;">MAC</th>
								<th valign="middle" style="text-align: center;">Device Brand</th>
								<th valign="middle" style="text-align: center;">Device Model</th>
