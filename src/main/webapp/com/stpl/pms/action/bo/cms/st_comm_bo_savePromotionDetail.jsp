...
<body>
	<s:form name="savePromotionDetail" id="savePromotionDetail" theme="simple"
		action="st_comm_bo_savePromotionDetail">
				...
				<div class="FormMainBox">
					...
					<div class="InputDiv">
						<s:if test="%{domainId>1}">
							<s:hidden name="savePromotionDetail.domainId" value="%{domainId}"
								id="domainId"></s:hidden>
							<s:property value="%{domainName}" />
						</s:if>
						<s:else>
							<ss:select theme="myTheme" cssClass="select1" list="%{domainMap}"
								name="savePromotionDetail.domainId" id="domainId" headerKey="-1"
				...
				<div class="FormMainBox">
					...
					<div class="InputDiv">
						<ss:select theme="myTheme" cssClass="select1" list="%{}"
							name="savePromotionDetail.aliasId" id="aliasId" headerKey="-1"
