			...
			<s:form id="playerSearchFrm" action="st_pms_bo_rep_searchReport"
				...
				<div class="innerBox">
					<div class="FormMainBox">
						...
						<div class="InputDiv">
							<div>
		                         	 <s:hidden  value="0" id="aliasId" requestParam="YES"></s:hidden>
					...
					<div class="InputDivHalf">
						<s:radio id="procName" name="procName"
							list="#{'LocationWiseWagerAndWinning':'Location Wise', 'plrWiseWagerWinningFromTablet':'Player Wise'}"
							value="%{procName}" theme="myTheme" />
					</div>
				</div>
				<div class="clearFRM"></div>
				</div>
