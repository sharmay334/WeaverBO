...
<html>
	...
	<body>
		...
		<div class="FormSection">
			...
			<s:form action="/com/stpl/pms/action/bo/um/bo_um_BoVoucher_Search.action" id="searchUserFrm"
				...
				<div class="innerBox">
					...
					<s:if test="%{userInfoBean.getUserType().equalsIgnoreCase('BO')}">
						...
						<div class="FormMainBox">
							...
							<div class="InputDiv">
								<s:select name="voucherBean.voucherName" headerKey="-1"
									headerValue="--Please Select--" list="voucherNameList"
