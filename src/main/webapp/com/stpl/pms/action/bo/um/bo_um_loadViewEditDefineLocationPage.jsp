...
<body>
	<div class="FormSection">
		...
		<div class="greyStrip">
			<h4>View/Edit Location</h4>
		</div>
		<s:form id="searchUserFrm"
			action="/com/stpl/pms/action/bo/um/bo_um_viewEditLocation_submit.action"
			target="searchResult" theme="simple">

			<div class="innerBox">
				<div class="FormMainBox">
					<div class="labelDiv">
						<label>Select Source</label><em class="Req">*</em>
					</div>
					<div class="InputDiv">
						<s:select name="sourceLoc" headerKey="-1" id="sourceLoc"
								headerValue="--Please Select--" list="sourceLocationList"
				...
				<div class="FormMainBox">
					<div class="labelDiv">
						<label>Select Target</label><em class="Req">*</em>
					</div>
					<div class="InputDiv">
						<s:select name="targetLoc" headerKey="-1" id="targetLoc"
								headerValue="--Please Select--" list="targetLocationList"
