								...
								if($("[data-dt-idx='5']").hasClass("nextCall")  && !($("#reportTable_next").hasClass("disabled"))) {
									...
									_ajaxCallJsonSynch(
											"com/stpl/pms/action/bo/reports/st_pms_bo_rep_searchMISReportOnClick.action?reportData="
													+ $(
															"#reportData")
															.val().slice(0, -1)+',"proceName":"playerPayCorrectionReport"}'
													+ "&startIndex="
													+ $(
															'#startIndex')
															.val()
...
<body>
	...
	<div class="FormSection">
		<s:if test="%{resultList!=null && resultList.size()>0}">
			<div class="greyStrip">
				<h4 style="float: left">
					Player Payment Correction Report For Domain :
				...
				<table cellspacing="0" cellpadding="4" border="0" align="center"
					...
					<thead>
						<tr class="headerRow">
							...
							<s:if test="%{domainName=='All'}">
								<th style="text-align: center;" id="domain">Domain Name</th>
							</s:if>
							...
							<th valign="middle" style="text-align: center;">Debit
								Amount</th>
							<th valign="middle" style="text-align: center;">Credit
								Amount</th>
							<th valign="middle" style="text-align: center;">Remarks</th>
							<th valign="middle" style="text-align: center;">Released By
							</th>
						</tr>
					</thead>
					<tbody></tbody>
