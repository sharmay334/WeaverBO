...
<body>
	...
	<div class="FormSection">
		<s:if
			test="%{frightReportMap!=null && frightReportMap.size()>0}">
			<div class="greyStrip">
				<h4 style="float: left">Fright Report</h4>
					...
					<thead>
						<tr>
						    ...
						    <th width="5%" valign="middle" id="th_1" 
								style="text-align: center;">Voucher Number</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_4">Transport Fright</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_2">Local Fright</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_2">Load Fright</th>
							<th width="5%" valign="middle" style="text-align: center;"
								id="th_2">Unload Fright</th>
							
							
						</tr>
					</thead>
					<tbody>
						<s:iterator value="frightReportMap" var="resultMapVar">
							<s:set var="attendanceMap" value="#resultMapVar.value" />
							<tr>
								<td width="5%" valign="middle" style="text-align: center;">	<s:property value="#attendanceMap.date" /></td>
								<td width="5%" valign="middle" style="text-align: center;"><s:property value="#attendanceMap.billVoucherNumber" /></td>
								<td width="5%" valign="middle" style="text-align: center;"><b><font color='green' ><s:property value="#attendanceMap.transportFright" /></font></b></td>
								<td width="5%" valign="middle" style="text-align: center;"><b><font color='green' ><s:property value="#attendanceMap.localFright" /></font></b></td>
								<td width="5%" valign="middle" style="text-align: center;"><b><font color='green' ><s:property value="#attendanceMap.loadFright" /></font></b></td>
								<td width="5%" valign="middle" style="text-align: center;"><b><font color='green' ><s:property value="#attendanceMap.unloadFright" /></font></b></td>
								
							</tr>
						</s:iterator>
						<tr>
								<td width="5%" valign="middle" style="text-align: center;">	`</td>
								<td width="5%" valign="middle" style="text-align: center;">TOTAL</td>
								<td width="5%" valign="middle" style="text-align: center;"><b><font color='red' ><s:property value="%{totalTransportFright}" /></font></b></td>
								<td width="5%" valign="middle" style="text-align: center;"><b><font color='red' ><s:property value="%{totalLocalFright}" /></font></b></td>
								<td width="5%" valign="middle" style="text-align: center;"><b><font color='red' ><s:property value="%{totalLoadFright}" /></font></b></td>
								<td width="5%" valign="middle" style="text-align: center;"><b><font color='red' ><s:property value="%{totalUnloadFright}" /></font></b></td>
