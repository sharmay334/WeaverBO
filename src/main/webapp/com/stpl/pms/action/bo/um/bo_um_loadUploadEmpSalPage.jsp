		...
		$.ajax({
			...
			success : function(result) {
				if(result=="success"){
					...
					swal({
						  title: "Good job!",
						  text: "Salary uploaded successfully!",
						  icon: "success",
						  button: "Close",
						});
					setTimeout(function(){
					...
					swal({
						  title: "Oops! Failed to upload salary",
...
<body>
	<div class="FormSection">
		...
		<s:form id="searchUserFrm"
			action="/com/stpl/pms/action/bo/um/bo_um_uploadSalary_submit.action"
				...
				<div class="FormMainBox">
							...
							<div class="InputDiv">
								<s:select theme="myTheme" cssClass="select1"
									list="%{employeeNames}"
									name="employeeName" id="employeeName" onchange="getEmployeeSalary(this.value)" headerKey="-1"
